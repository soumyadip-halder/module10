...
import {fetchIt} from '../redux/vegan/actions';
...
mapStateToProps = state => {
  return {
    fetching: state.allReducer.loading,
    success: state.allReducer.data,
    error: state.allReducer.error,
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(Vegan);
